...
const standardFallbackSubjects: { [phase: string]: string[] } = {
  ...
  "E": ["Matematika", "Pendidikan Pancasila", "Bahasa Indonesia", "Bahasa Inggris", "Fisika", "Kimia", "Biologi", "Sejarah", "Geografi", "Ekonomi", "Sosiologi", "Informatika", "Seni Rupa", "Seni Musik", "Seni Teater", "Seni Tari", "Pendidikan Agama Islam dan Budi Pekerti", "Pendidikan Agama Kristen dan Budi Pekerti", "Pendidikan Agama Katolik dan Budi Pekerti", "Pendidikan Agama Hindu dan Budi Pekerti", "Pendidikan Agama Buddha dan Budi Pekerti", "Pendidikan Agama Khonghucu dan Budi Pekerti"],
